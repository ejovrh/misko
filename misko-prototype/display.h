...
// data start
	// datetime
		...
		M2_LIST(el_datetime_list) { &el_hlist_datetime, &el_hlist_utc, &el_datetime_ok} ;
	...
	// position
		...
		M2_LIST(el_gps_list) = {&el_gps_latitude, &el_gps_longtitude, &el_gps_hlist_alt_fix_list, &el_hlist_sat_dop, &el_position_ok};
	...
	// cellular
		...
		M2_LIST(el_gsm_foo3_list) = {&el_gsm_foo3_str, &el_whitespace, &el_gsm_foo3, &el_whitespace, &el_cellular_ok};
	...
	// device status
		...
		M2_LIST(el_device_misc_list) = {&el_power_hlist, &el_hlist_batt, &el_hlist_vcc_temp, &el_device_status_ok};
...
// settings start
	// logging
		...
		M2_LIST(el_sd_list) = { &el_sd_write, &el_sd_write_setting, &el_stat_write, &el_stat_write_setting, &el_logging_ok };
	...
	// Bluetooth
		...
		M2_LIST(el_bluetooth_list) = { &el_bluetooth_power, &el_bluetooth_power_value, &el_bluetooth_power_timeout, &el_bluetooth_ok };
	...
	// display
		...
		M2_LIST(el_lcd_list) = { &el_lcd_power, &el_lcd_power_value, &el_lcd_power_timeout, &el_display_ok };
	...
	M2_LIST(el_accel_list) = { &el_accel_str, &el_accel_enable_value, &el_accel_sleep_str, &el_accel_timeout, &el_accel_act_thresh_str, &el_accel_act_thresh_val, &el_accel_inact_thresh_str, &el_accel_inact_thresh_val, &el_accelerometer_ok };
