...
#define gps_green_led_pin 28								// PA4 - GPS_GREEN_LED_PIN
#define gps_red_led_pin 29									// PA5 - GPS_RED_LED_PIN
#define gprs_status_led_pin	30							// PA6 - GPRS_STATUS
#define GPS_wakeup_pin  31 									// PA7 - GPS_WAKEUP_PIN
...
// port C
#define menu_gprs_push_button_pin 32				// PC0 - MENU_GPRS_POWER_BUTTON_PIN
#define menu_down_button_pin 33 						// PC1 - MENU_DOWN_BUTTON_PIN
#define menu_right_button_pin 34						// PC2 - MENU_RIGHT_BUTTON_PIN
#define menu_left_button_pin 35							// PC3 - MENU_LEFT_BUTTON_PIN
#define menu_center_button_pin 36						// PC4 - MENU_CENTER_BUTTON_PIN
#define menu_up_button_pin 37 							// PC5 - MENU_UP_BUTTON_PIN
#define Bluetooth_wakeup_pin 38 						// PC6 - BLUETOOTH_WAKEUP_PIN
#define analog_sw_ctrl_pin 39 							// PC7 - ANALOG_SW_CTRL_PIN
...
#define GPS_power_ctl_pin 	42  						// PG2 - GPS_POWER_CTL_PIN
