...
#define GPS_wakeup_pin  25									// PA1 - GPS_WAKEUP_PIN
#define GPS_power_ctl_pin 26								// PA2 - GPS_POWER_CTL_PIN
#define Bluetooth_wakeup_pin 27							// PA3 - BLUETOOTH_WAKEUP_PIN
#define MCP73871_charge_status_1_pin 28			// PA4 - MCP73871_CHARGE_STATUS_1_PIN
#define MCP73871_charge_status_2_pin 29			// PA5 - MCP73871_CHARGE_STATUS_2_PIN
#define MCP73871_power_good_pin	30					// PA6 - MCP73871_POWER_GOOD_PIN
#define Buzzer_pin 31 											// PA7 - BUZZER_PIN

// port B
#define SPI_SS_SD_card_pin 8								// PB0 - SPI_SS_SD_CARD_PIN
...
// port C
#define menu_left_button_pin 32							// PC0 - MENU_LEFT_BUTTON_PIN
#define menu_up_button_pin  33 							// PC1 - MENU_UP_BUTTON_PIN
#define menu_right_button_pin 34						// PC2 - MENU_RIGHT_BUTTON_PIN
#define menu_down_button_pin 35							// PC3 - MENU_DOWN_BUTTON_PIN
#define menu_bluetooth_power_toggle_pin  36	// PC4 - MENU_BLUETOOTH_POWER_TOGGLE_PIN
#define menu_center_button_pin 37 					// PC5 - MENU_CENTER_BUTTON_PIN
#define gps_red_led_pin 38 									// PC6 - GPS_RED_LED_PIN
#define gps_green_led_pin 39 								// PC7 - GPS_GREEN_LED_PIN
...
#define SPI_RTC_SS_pin 2										// PE2 - SPI_SS_RTC_PIN
#define SD_card_detect_pin 3								// PE3 - SD_CARD_DETECT_PIN
#define SPI_FRAM_SS_pin 4 	 								// PE4 - SPI_FRAM_SS_PIN
#define SPI_SS_ADXL345_pin 5 								// PE5 - SPI_SS_ADXL345_PIN
...
// port G
																						// PG0 - not used
																						// PG1 - not used
#define menu_gprs_push_button_pin	42  			// PG2 - MENU_GPRS_PUSH_BUTTON_PIN
