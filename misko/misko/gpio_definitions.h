...
#define    ADXL345_INT1_interrupt_pin		D,   0,   0							// ADXL345_INT1_INTERRUPT_PIN - interrupt sense for accelerometer events
#define    RTC_INT_interrupt_pin			D,   1,   1							// RTC_INT_INTERRUPT_PIN - interrupt sense for RTC events
