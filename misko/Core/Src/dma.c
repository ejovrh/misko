...
void MX_DMA_Init(void)
{
  ...
  hdma_memtomem_dma2_channel2.Init.PeriphInc = DMA_PINC_ENABLE;
  hdma_memtomem_dma2_channel2.Init.MemInc = DMA_MINC_ENABLE;
  hdma_memtomem_dma2_channel2.Init.PeriphDataAlignment = DMA_PDATAALIGN_BYTE;
  hdma_memtomem_dma2_channel2.Init.MemDataAlignment = DMA_MDATAALIGN_BYTE;
  hdma_memtomem_dma2_channel2.Init.Mode = DMA_NORMAL;
  hdma_memtomem_dma2_channel2.Init.Priority = DMA_PRIORITY_LOW;
