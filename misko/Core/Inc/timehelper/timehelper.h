...
{
	uint8_t FlagRTChasCorrectTime :1;  // flag indicating that the RTC has the correct time
	uint8_t FlagGPShasCorrectTime :1;  // flag indicate that the GPS module has the correct time
